...
plot_rate_boxes(inflation_euro_other_avg_data, "Poziom inflacji od 2012 do 2016 roku", "inflation")
...
###### Summary
summary_eurozone_inflation_data <- inflation_euro_other_avg_data |> filter(origin == 'Kraje.w.strefie.Euro') |> summary()
summary_other_inflation_data <- inflation_euro_other_avg_data |> filter(origin == 'Kraje.poza.strefa.Euro') |> summary()
