...
plot_histogram_single(inflation_euro_other_avg_data, "Histogram poziomów inflacji od 2005 do 2018 roku")

# Histogram of inflation rate differences (single)
plot_histogram_diff_single(inflation_diff_eurozone_other_data, "Histogram różnic poziomów inflacji z miesiąca na miesiąc od 2005 do 2018 roku")
